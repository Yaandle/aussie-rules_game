...
- **AFL HERO** — a swipe-based possession puzzle mode: 30 hand-placed levels across six leagues of escalating difficulty — Juniors, Representative, Academy, Seniors, State, Country. Clear every level in a league and a GO TO THE LEAGUE option swipes you into the next one.
